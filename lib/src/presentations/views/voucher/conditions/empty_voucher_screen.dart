...
class EmptyVoucherScreen extends StatelessWidget {
  const EmptyVoucherScreen({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const ErrorInfo(
              title: "Empty Vouchers",
              description:
                  "It looks like you don't have any vouchers created. Start Your Journey Now!.",
